...
// 22
Point(22) = {xw2, yw2, zw2, 1.0}; // centre of well 2

Point(23) = {xw2-rw*Cos(theta), yw2-rw*Sin(theta), 0, 1.0};
Point(24) = {xw2-rw*Cos(theta), yw2+rw*Sin(theta), 0, 1.0};
Point(25) = {xw2+rw*Cos(theta), yw2+rw*Sin(theta), 0, 1.0};
Point(26) = {xw2+rw*Cos(theta), yw2-rw*Sin(theta), 0, 1.0};

Point(27) = {xw2-d, yw2-d, 0, 1};
Point(28) = {xw2+d, yw2-d, 0, 1};
Point(29) = {xw2-d, yw2+d, 0, 1};
Point(30) = {xw2+d, yw2+d, 0, 1};

Point(31) = {xw2-d, yw+d, 0, 1};
Point(32) = {xw2+d,  yw+d, 0, 1};
Point(33) = {xw2-d, y, 0, 1};
Point(34) = {xw2+d, y, 0, 1};


Point(35) = {xw+d, yw2-d, 0, 1};
Point(36) = {y, yw2-d, 0, 1};
Point(37) = {xw+d, yw2+d, 0, 1};
Point(38) = {y, yw2+d, 0, 1};
...
Line Loop(78) = {77, 68, -74, -73};
Plane Surface(79) = {78};
Line Loop(80) = {74, 64, -75, -70};
